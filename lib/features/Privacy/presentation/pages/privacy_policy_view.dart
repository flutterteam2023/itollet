  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:  SingleChildScrollView(
        ...
        Kişisel verileriniz, veri sorumlusu sıfatıyla Ankara Ticaret Sicil Müdürlüğü nezdinde 466066 sicil numarası ile kayıtlı ve şirket merkezi Kızılırmak Mah. Dumlupınar Blv A Blok 9A 158 Çankaya-Ankara adresinde bulunan SMALT ELEKTRONİK HİZMETLER VE TİC AŞ (Şirket) tarafından 6698 sayılı Kişisel Verilerin Korunması Kanunu (KVKK) başta olmak üzere, ilgili mevzuat düzenlemeleri ve yetkili otorite kararları/duyuruları ile işbu Gizlilik Politikası çerçevesinde işlenmektedir.
        ...
        Şirket, internet sitesi üzerinden yaptığınız hizmet alımlarında güvenliğinizi önemsemektedir. Bu nedenle kredi kartı bilgileriniz sadece satın alım işlemi gerçekleştirilirken kullanılır ve veri tabanında kayıtlı olarak tutulmaz.
        ...
        Üye olurken doğrudan paylaşılan veriler üyelik süresinin devamı boyunca saklanmaktadır. Bültene abone olurken paylaşılan veriler abonelikten ayrılana kadar sistemde saklanmaktadır. IP adresleri sistemde 0 saat boyunca saklanmaktadır.
        
        Kişisel Verilerin Ne Şekilde İşlenebileceği
        6698 sayılı Kişisel Verilerin Koruması Kanunu (KVKK) uyarınca, SMALT ELEKTRONİK HİZMETLER VE TİC AŞ ile paylaşılan kişisel veriler, tamamen veya kısmen, otomatik olarak veya herhangi bir veri kayıt sisteminin parçası olmak kaydıyla otomatik olmayan yollarla elde edilerek, kaydedilerek, depolanarak, değiştirilerek, yeniden düzenlenerek kısacası veriler üzerinde gerçekleştirilen her türlü işleme konu olarak tarafımızca işlenebilecektir. KVKK kapsamında veriler üzerinde gerçekleştirilen her türlü işlem "kişisel verilerin işlenmesi" olarak kabul edilmektedir.
        
        Kişisel Verilerin Aktarılabileceği Üçüncü Kişi Veya Kuruluşlar Hakkında Bilgilendirme
        Yukarıda belirtilen amaçlarla, SMALT ELEKTRONİK HİZMETLER VE TİC AŞ ile paylaşılan kişisel verilerin aktarılabileceği kişi ve kuruluşlar; ana hissedarlar, hissedarlar, reklam verenler, doğrudan veya dolaylı yurtiçi/ yurtdışı iştiraklerimiz; başta SMALT ELEKTRONİK HİZMETLER VE TİC AŞ altyapısını kullanan üye firmalar ve bunlarla sınırlı olmamak üzere sunulan hizmet ile ilgili kişi ve kuruluşlar olmak üzere, faaliyetlerimizi yürütmek üzere veya Veri İşleyen sıfatı ile hizmet aldığımız, iş birliği yaptığımız, program ortağı kuruluşları, yurtiçi/yurtdışı kuruluşlar ve diğer 3. kişiler ve kuruluşlardır. Mahkemelerden gelen bağlayıcı taleplere yönelik olarak hukuki yükümlülüklerimiz dahilinde verileriniz istisnai olarak resmi kurumlarla paylaşılabilecektir.
        Reklam amaçlı kullanılacak çerezlere ilişkin düzenlemelerimiz "SMALT ELEKTRONİK HİZMETLER VE TİC AŞ Çerez Politikası" olup, şu anda okuduğunuz "Gizlilik ve Kişisel Verilerin Korunması Politikası'nın bir parçasını oluşturmaktadır. Çerez Politikamız hakkında bilgi edinmek için lütfen tıklayın.
        
        KVKK Yürürlüğe Girmeden Önce Elde Edilen Kişisel Veriler
        SMALT ELEKTRONİK HİZMETLER VE TİC AŞ internet sitesinde KVKK'nın yürürlük tarihi olan 07.04.2016 tarihinden önce depolanan kişisel veri bulunmamaktadır.
        ...
        Kanun kapsamında, kişisel verileriniz ile ilgili her türlü talep, şikayet ve önerilerinizi, kimliğinizi tevsik edici belgeler ve talebinizi içeren dilekçeniz ile aşağıdaki adresimize ulaştırabilir veya güvenli elektronik imza kullanmak suretiyle Şirketimizin av.altantas@gmail.com kayıtlı elektronik posta adresine gönderebilirsiniz.
