...
mixin _$CategoryModel {
  ...
  int? get orderBy =>
      throw _privateConstructorUsedError; //firebase de renkler argb formatında olmalı örneğin
...
abstract class $CategoryModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      String? iconUrl,
      int? orderBy,
      @ColorSerializer() Color? primaryColor,
      @ColorSerializer() Color? secondaryColor,
...
class _$_CategoryModel implements _CategoryModel {
  _$_CategoryModel(
      ...
      this.orderBy = 0,
      @ColorSerializer() required this.primaryColor,
      @ColorSerializer() required this.secondaryColor,
...
//255, 244, 67, 54 şeklinde string olarak gelmeli
  ...
  @override
  String toString() {
    return 'CategoryModel(name: $name, iconUrl: $iconUrl, orderBy: $orderBy, primaryColor: $primaryColor, secondaryColor: $secondaryColor, subCategories: $subCategories)';
  }
...
abstract class _CategoryModel implements CategoryModel {
  factory _CategoryModel(
      ...
      final int? orderBy,
      @ColorSerializer() required final Color? primaryColor,
      @ColorSerializer() required final Color? secondaryColor,
      required final List<SubcategoryModel> subCategories}) = _$_CategoryModel;
  ...
  @override
  int? get orderBy;
  @override //firebase de renkler argb formatında olmalı örneğin
//255, 244, 67, 54 şeklinde string olarak gelmeli
  @ColorSerializer()
